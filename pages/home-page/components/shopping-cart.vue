            ...
            <block v-for="(item,index) in shopping_card" :key="index">
                <view class="goods-list" v-if="item.quantity > 0">
                    ...
                    <view class="goods-quantity">
                        <view>
                            <image src="/static/tab/jianhao.png" mode="widthFix"
                                @click="reduce(index,item.quantity,item._id,item.cid,item.good_index,item.unitprice)">
                            </image>
                        </view>
                        <view>{{item.quantity}}</view>
                        <view>
                            <image src="/static/tab/jia.png" mode="widthFix"
                                @click="plus(index,item.quantity,item._id,item.cid,item.good_index,item.unitprice)">
                            </image>
                        </view>
                    </view>
                </view>
