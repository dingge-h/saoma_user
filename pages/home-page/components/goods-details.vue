            ...
            <view class="details-padd">
                ...
                <view class="describe">
                    ...
                    <view class="details-quantity">
                        <view>
                            <image v-if="new_data.res_data.itemgood.quantity > 0" src="/static/tab/jianhao.png"
                                @click="reduce(new_data.res_data)"></image>
                        </view>
                        <view><text
                                v-if="new_data.res_data.itemgood.quantity > 0">{{new_data.res_data.itemgood.quantity}}</text>
                        </view>
                        <view>
                            <image src="/static/tab/jia.png" @click="plus(new_data.res_data)"></image>
                        </view>
                    </view>
                </view>
            </view>
            ...
            <view class="details-padd specs-goods" v-if="new_data.res_data.itemgood.att_hide">
                ...
                <view class="specs-goods-flex">
                    <block v-for="(item,index) in new_data.res_data.itemgood.specs" :key="index">
                        <text @click="menubtn(item.attribute,item.unitprice,new_data.res_data)"
                            :class="{'attr-back' : index == new_data.res_index}">{{item.attribute}}</text>
                    </block>
                </view>
            </view>
